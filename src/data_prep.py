...
from qlora_utils import BASE_MODEL_NAME, MAX_SEQ_LENGTH

DATASET_NAME = "Redgerd/roman-urdu-alpaca-qa-mix"
RU_SOURCE_FILE = "roman_urdu_QA_full_alpaca.jsonl"
DEFAULT_OUT_DIR = Path(__file__).resolve().parent.parent / "data" / "processed" / "roman_urdu_qa"

# Common Roman Urdu function words -- unlikely to appear in English text, used
# only as a cross-check against the file-membership signal, not as the primary
# filter.
RU_STOPWORDS = {
    "hai", "hain", "ka", "ki", "ke", "aur", "mein", "se", "ko", "kya", "nahi", "nahin",
    "tha", "thi", "thay", "ho", "hoga", "hogi", "kar", "kaise", "kyun", "kahan", "kab",
    "ap", "aap", "tum", "mera", "meri", "mere", "humara", "unka", "iska", "uska",
    "hy", "per", "liye", "wala", "wali", "wale", "kuch", "sab", "yeh", "woh", "koi",
}
